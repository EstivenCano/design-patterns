...
export const AppBar = () => {
  return (
    <header className='flex justify-center supports-backdrop-blur:bg-background/60 sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur px-4 lg:px-20 py-2'>
